...
nbins = 20
x50 = np.loadtxt('pos_N50_t.1.txt', unpack=True)
r50 = r(x50)
x100 = np.loadtxt('pos_N100_t.1.txt', unpack=True)
r100 = r(x100)
x500 = np.loadtxt('pos_N500_t.1.txt', unpack=True)
r500 = r(x500)
x1000 = np.loadtxt('pos_N1000_t.1.txt', unpack=True)
r1000 = r(x1000)
...
data = np.array([np.loadtxt("pos_N" + str(i) + "_t.1.txt", unpack=True) for i in nhits])
